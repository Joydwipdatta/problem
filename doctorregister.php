...
if(isset($_POST['submit'])){
    ...
    if($count>0) {
       echo "please enter new user id";
        ...
        $query="INSERT INTO `doctor`(dname,dphone,demail,duid,dpassword,dspeciality,daddress,dimage)  VALUES ('$dname','$dphone','$demail','$duid','$dpassword','$dspeciality','$daddress','$upload_image')";
        $result= mysqli_query($connection,$query);
    if($result){
        ...
        <section class="drbody">
            ...
            <div class="dr">
                ...
                <div class="drform">
                    ...
                    <form action="doctorregister.php" method="POST" class="drfr">
