    ...
    <div class="bar">
        <div class="sidebar">
            <div class="profile">
                ...
                <img src="/images/<?php echo $result['dimage']?>">
            ...
            <div class="mainbody">
                ...
                <div class="appointmentslot">
                    ...
                    <div class="slot">
                        ...
                        <button class="accordion">Monday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Tuesday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Wednesday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Thursday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Friday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Saturday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
                        ...
                        <button class="accordion">Sunday<ion-icon name="chevron-down-outline" class="panelicon"></ion-icon></button>
                        <div class="panel">
                            <table>
                                <tr>
